...
final class FeedSnapshotTests: XCTestCase {
    ...
    func test_feedWithContent() {
        ...
        record(snapshot: sut.snapshot(for: .iPhone8(style: .light, contentSize: .extraExtraExtraLarge)), named: "FEED_WITH_CONTENT_extraExtraExtraLarge_light")
    }
    ...
    func test_feedWithFailedImageLoading() {
        ...
        record(snapshot: sut.snapshot(for: .iPhone8(style: .light, contentSize: .extraExtraExtraLarge)), named: "FEED_WITH_FAILED_IMAGE_extraExtraExtraLarge_light")
    }
...
private extension FeedSnapshotTests {
    ...
    private func feedWithLoadMoreIndicator() -> [CellController] {
        let loadMoreController = LoadMoreCellController(loadMoreHandler: {})
