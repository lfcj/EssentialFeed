...
class EssentialFeedAPIEndToEndTests: XCTestCase {
    ...
    func test_endToEndTestServerGETFeedImageDataResult_matchesFixedTestAccountData() {
        ...
        case .success(let data)?:
            XCTAssertFalse(data.isEmpty, "Data received should not be empty")
        case .failure(let error)?:
            XCTFail("Expected successful result and got an error: \(error)")
        default:
            XCTFail("Expected successful result and no result instead")
        }
    }
